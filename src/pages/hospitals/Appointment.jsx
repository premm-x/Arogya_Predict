    ...
    return (
        <div className="">
                    ...
                    <section className=" flex flex-col gap-4 ">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            <div className="flex-1 bg-violet-400 rounded-2xl h-40 md:h-56">
                                <p className="text-[200px] font-bold leading-none">Appointment</p>
                            </div>
                            <div className="flex-1 bg-amber-500 rounded-2xl h-40 md:h-56"></div>
                        </div>

                        {/* Main content */}
                        <div className=" border-2 border-black/50 rounded-2xl flex-1">
                            <AppointmentTable/>
                        </div>
            ...
            <div className="h-87.5 overflow-hidden flex items-end bg-red-800 rounded-t-2xl mt-5">
                <p className="text-[300px] font-bold leading-none">Appointment</p>
            </div>
